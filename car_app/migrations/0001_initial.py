    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_photo_1', models.ImageField(blank=True, upload_to='car_photo/')),
                ('car_photo_2', models.ImageField(blank=True, upload_to='car_photo/')),
                ('car_photo_3', models.ImageField(blank=True, upload_to='car_photo/')),
                ('car_photo_4', models.ImageField(blank=True, upload_to='car_photo/')),
                ...
                ('passenger', models.ImageField(upload_to='')),
                ...
                ('create_data', models.DateTimeField(blank=True, default=datetime.datetime.now)),
            ],
        ),
    ]
